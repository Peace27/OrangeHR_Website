...
from Locator_Page.Locators_Page import LoginLocatorsPage, AdminLocatorsPage, AdminJobIconLocators, \
    AdminOrganisationIconLocators, AdminQualificationsIconLocators, AdminNationalitiesIconLocators, \
    AdminCorporateBrandingIconLocators, AdminConfigurationIconLocators
